...
| error | `error` (`#DC2626`) 1px border + `error` 색상 helper text + 상단 `error-light` 6% tint (선택, 강한 강조 시) |
...
| Token | text | contrast |
|---|---|---|
| `alert-text-success-on-dark` | `success-light` (`#4ADE80`) | **9.42:1** ✅ |
| `alert-text-error-on-dark` | `error-light` (`#F87171`) | **5.93:1** ✅ |
| `alert-text-warning-on-dark` | `warning-light` (`#FB923C`) | **7.25:1** ✅ |
| `alert-text-info-on-dark` | `info-light` (`#60A5FA`) | **6.46:1** ✅ |
